...
def datos_handle(hdl,especialista,maestria,referencista):

    estudiantes = get_data(hdl , maestria)
    create_certif(estudiantes=estudiantes,especialista=especialista,referencista=referencista)
...
def create_certif(estudiantes: tuple, especialista: str, referencista: str) -> bool:
